    ...
    //log.addEventListener('keypress', phonenumber);
    ...
    function clearBoxes() {
        ...
        var selectedDocuments1 = document.getElementsByClassName("div_DrinksComments");
        //document.getElementsByClassName("div_DrinksComments")
    ...
    function addDrinkComment(test) {
        ...
        if (test.checked) {
            ...
            //var checkBx_drink = `<br class="div_DrinksComments"><br class="div_Drinks"><label for='checkBoxDrinks' class='div_DrinksComments'>Any Additional customisations*:</label><textarea class="div_DrinksComments" name="textAdditonalComments" id="commentsforDrinks" placeholder="Your comments" rows="5" cols="25"></textarea><p Class="Validation" id="valtextAdditonalComments">Enter comments</p>`
    ...
    function validate() {
        ...
        for (let index = 0; index < inpCol.length - 1; ++index) {
            ...
            switch (inpCol[index].type) {
                ...
                // 		// if(index >0){
                // 		//  isValidArray[0] = "X"
                // 		// 	//isValidArray.splice(index, 0)

                // 		// }
                // 		// if(index >1){
                // 		// 	isValidArray[0] = "X"
                // 		// 	//isValidArray.splice(index, 1)
                // 		// 	isValidArray[1] = "X"
                // 		// 	//isValidArray.splice(index, 0)
                // 		// }						
                // 		break;
    ...
    function resetFUNC() {
        // var getTable = document.getElementById("myTable")			
        // getTable.getElementsByTagName("tr")[1].remove();
        // document.getElementById("div_myTable").style.display = "none"
    ...
    function clearValid(){
        ...
        for (let index = 0; index < inpCol.length - 1; ++index) {
            console.log(inpCol[index].type);
            if(inpCol[index].name != "emailId" ||inpCol[index].name !="phoneNumber" ||inpCol[index].name !="zipcode" ){
